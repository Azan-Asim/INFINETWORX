    ...
    return(
      ...
      <h1>
            ...
            <motion.span
                  ...
                  viewport={{ once: false }}
                  transition={{ ease: "easeInOut", duration: 0.1, delay: 0.2 }}>Be your own platform.</motion.span><br/>
   <motion.span
                  initial={{ opacity: 0, y: -30 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  viewport={{ once: false }}
                  transition={{ ease: "easeInOut", duration: 0.3, delay: 0.2 }}>  Share freely and fairly.<br/></motion.span>     
   <motion.span
                  initial={{ opacity: 0, y: -30 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  viewport={{ once: false }}
                  transition={{ ease: "easeInOut", duration: 0.5, delay: 0.2 }}>   Participate, and own a piece.<br/></motion.span><br/>          </h1>
    </div>
